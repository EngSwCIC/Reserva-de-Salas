...
Funcionalidade: pesquisar usuários de uma tabela pelo nome
    ...
    Cenário: pesquisar usuário através do curso
        Dado que exista um usuário com nome "João", curso "Matemática", email "joao@gmail.com", registro "130123456"
        Quando eu escrever no campo "q[username_or_course_or_registration_cont]" o nome "Matemática"
        E clicar no botão de busca "Search"
        Então eu devo ver uma tabela com o nome "João" e seus respectivos dados:
            | username     | João           |
            | course       | Matemática     |
    ...
    Cenário: pesquisar o curso de um usuário não cadastrado
        Dado que exista um usuário com nome "João", curso "Matemática", email "joao@gmail.com", registro "130123456"
        Quando eu escrever no campo "q[username_or_course_or_registration_cont]" o nome "Letras"
        E clicar no botão de busca "Search"
        Então não deve haver resultados da busca

    Cenário: pesquisar usuário através da matrícula
        Dado que exista um usuário com nome "João", curso "Matemática", email "joao@gmail.com", registro "130123456"
        Quando eu escrever no campo "q[username_or_course_or_registration_cont]" o nome "130123456"
        E clicar no botão de busca "Search"
        Então eu devo ver uma tabela com o nome "João" e seus respectivos dados:
            | username     | João           |
            | course       | Matemática     |
    ...
    Cenário: pesquisar a matrícula de um usuário não cadastrado
        Dado que exista um usuário com nome "João", curso "Matemática", email "joao@gmail.com", registro "130123456"
        Quando eu escrever no campo "q[username_or_course_or_registration_cont]" o nome "matriculainvalida"
        E clicar no botão de busca "Search"
        Então não deve haver resultados da busca
