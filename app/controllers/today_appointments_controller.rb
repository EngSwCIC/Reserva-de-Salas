...
class TodayAppointmentsController < ApplicationController
  ...
  #
  # Em seguida, a data é passada para a função _where_ para selecionar apenas alugueis do dia, instanciando _appointments_today_...
  def index
